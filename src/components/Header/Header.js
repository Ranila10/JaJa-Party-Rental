...
const authenticatedOptions = (
  <Fragment>
    {/* <NavLink to='/index' className='nav-link'>See all rental</NavLink> */}
...
const Header = ({ user }) => (
  ...
  <Navbar className="nav-bar" variant="light" expand='md'>
    <Navbar.Brand>
      <Link to='/' style={{ color: '#FFF', textDecoration: 'none' }}>Jaja Party Rental</Link>
    </Navbar.Brand>
